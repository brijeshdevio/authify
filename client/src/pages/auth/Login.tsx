    ...
    <form className="space-y-5" onSubmit={handleSubmit(submit)}>
      ...
      <Input
        ...
        leftEle={
          <Link
            to="/forgot-password"
            className="link text-[13px] font-medium underline hover:text-primary"
          >
            Forgot password?
          </Link>
        }
      ...
      <div className="flex items-center gap-2">
        <input
          className="border-outline-variant h-4 w-4 rounded text-primary focus:ring-primary"
          id="remember"
          type="checkbox"
        />
        <label className="text-on-surface-variant text-sm" htmlFor="remember">
      ...
      <main className="relative flex flex-grow items-center justify-center overflow-hidden p-6">
        ...
        <div className="glass-panel relative z-10 grid w-full max-w-[1100px] overflow-hidden rounded-xl shadow-[0_20px_40px_rgba(25,28,30,0.05)] md:grid-cols-2">
          ...
          <div className="bg-surface-container-lowest flex flex-col justify-center sm:p-8 md:p-12 lg:p-16">
            ...
            <Form />
            <p className="text-on-surface-variant mt-5 text-center text-sm">
