        ...
        <table width="500" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 4px 10px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="padding:30px; color:#333;">
              ...
              <p style="line-height:1.6;">
                <a href="${env.FRONTEND}/reset-password/${token}" style="background-color:#4f46e5; color:#ffffff; padding:10px 20px; display:block; text-decoration:none;width:fit-content;margin:10px auto;">Reset Password</a>
              </p>
              <p style="line-height:1.6;">
